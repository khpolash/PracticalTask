...
public class IndividualCustomerService : BaseService<IndividualCustomer, IndividualCustomerVm>, IIndividualCustomerService
{
    public IndividualCustomerService(PracticalTaskDbContext context, IMapper mapper) : base(context, mapper)
    {
    }
